...
CSdiSampleDoc::CSdiSampleDoc() noexcept
{
...
void CSdiSampleDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
void CSdiSampleDoc::InitializeSearchContent()
{
...
void CSdiSampleDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
