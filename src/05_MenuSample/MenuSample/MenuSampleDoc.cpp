...
// MenuSampleDoc.cpp: CMenuSampleDoc 클래스의 구현
//
...
// CMenuSampleDoc 생성/소멸

CMenuSampleDoc::CMenuSampleDoc() noexcept
{
...
BOOL CMenuSampleDoc::OnNewDocument()
{
...
// 축소판 그림을 지원합니다.
void CMenuSampleDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
...
// 검색 처리기를 지원합니다.
void CMenuSampleDoc::InitializeSearchContent()
{
...
void CMenuSampleDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
